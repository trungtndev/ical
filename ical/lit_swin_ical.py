...
class LitICAL(pl.LightningModule):
    ...
    def validation_step(self, batch: Batch, _):
        ...
        self.log(
            "val_fusion_loss",
            fusion_loss, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True,
        )
        self.log(
            "val_exp_loss",
            exp_loss, on_step=False, on_epoch=True, prog_bar=False, sync_dist=True,
        )
        self.log(
            "val_imp_loss",
            implicit_loss, on_step=False, on_epoch=True, prog_bar=False, sync_dist=True,
        )
        ...
        self.log(
            "val_ExpRate",self.exprate_recorder, prog_bar=True, on_step=False, on_epoch=True,
        )
